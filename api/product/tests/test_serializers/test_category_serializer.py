...
class CategorySerializerTests(APITestCase):
    def setUp(self):
        self.clothes_category = Category.objects.create(
            name="Roupas",
            slug="Calças",
            description="Categoria para roupas",
            active=True,
        )
        self.kitchen_category = Category.objects.create(
            name="Cozinha",
            slug="Utensilios",
            description="Categoria para utensílios de cozinha",
            active=True,
        )
    ...
    def test_category_serializer_whenCategory_created(self):
        ...
        serializer = CategorySerializer(
            [self.clothes_category, self.kitchen_category], many=True
        )
    ...
    def test_category_serializer_whenCategory_created_hasError(self):
        ...
        self.assertNotEqual(
            data[0]["description"], "Categoria para utensílios de cozinha"
        )
